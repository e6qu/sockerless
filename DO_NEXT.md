...
Current phase: AWS RDS + ElastiCache client-surface coverage from BUG-1104 / BUG-1228 / BUG-1229 is closed. No issue-driven implementation branch remained active after that PR merged.
