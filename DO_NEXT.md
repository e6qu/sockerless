...
Current phase: AWS RDS + ElastiCache client-surface coverage from BUG-1104 / BUG-1228 / BUG-1229 and the PR #289 CI follow-up BUG-1232/#290, BUG-1234/#292, and BUG-1235/#293 are closed. BUG-1233/#291 remains open for AWS Route 53 `ListHostedZonesByName`. No implementation branch remained active after PR #289 merged.
