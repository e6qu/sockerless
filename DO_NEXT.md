...
Current phase: AWS API Gateway client-surface coverage from BUG-1104 / BUG-1227 is closed. No issue-driven implementation branch remained active after that PR merged.
