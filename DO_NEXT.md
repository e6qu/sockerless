...
`feat/bleephub-repository-license-graphql` — Bleephub repository metadata now uses real persisted repository and Pages state for license metadata, feature flags, merge-method settings, and Pages capability instead of null/hardcoded compatibility shapes.
