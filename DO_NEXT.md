...
`feat/ecs-express-mode` — full AWS **ECS Express Mode** support in the AWS simulator (the managed Express Gateway service AWS launched 2025-11-21), plus the real upgrades the feature exposed. **PR #634, CI green.** Highlights:
