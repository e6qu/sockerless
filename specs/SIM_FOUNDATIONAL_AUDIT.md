...
| Event routing | Missing EventBridge | Missing Eventarc | Missing Event Grid | Real gap. Tracked as BUG-1197, BUG-1198, BUG-1199. |
...
- EventBridge (`events` API). BUG-1197.
- Kinesis stream ingestion. BUG-1200.
...
- Eventarc event routing. BUG-1198.
...
- Event Grid event routing. BUG-1199.
- Event Hubs stream ingestion. BUG-1200.
...
2. Event routing: add AWS EventBridge, GCP Eventarc, and Azure Event Grid as one cross-cloud PR. These are directly analogous public cloud event-routing services and have clear SDK/CLI/Terraform surfaces.
