...
|---|---|---|---|---|---|
| `POST /v2/entries:list` | ✓ `simulators/gcp/logging.go:151::func` | ✗ (deferred under BUG-1159 sweep) | ✗ (deferred under BUG-1147 sweep) | n/a | |
| `POST /v2/entries:write` | ✓ `simulators/gcp/logging.go:164::func` | ✗ (deferred under BUG-1159 sweep) | ✗ (deferred under BUG-1147 sweep) | n/a | |
