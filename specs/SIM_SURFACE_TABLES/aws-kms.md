...
| `Action TrentService.Sign` | ✓ `simulators/aws/kms_crypto.go:46::handleKMSSign` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action TrentService.Verify` | ✓ `simulators/aws/kms_crypto.go:47::handleKMSVerify` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action TrentService.GetPublicKey` | ✓ `simulators/aws/kms_crypto.go:48::handleKMSGetPublicKey` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action TrentService.GenerateMac` | ✓ `simulators/aws/kms_crypto.go:49::handleKMSGenerateMac` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action TrentService.VerifyMac` | ✓ `simulators/aws/kms_crypto.go:50::handleKMSVerifyMac` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action TrentService.GenerateDataKeyPair` | ✓ `simulators/aws/kms_crypto.go:51::handleKMSGenerateDataKeyPair` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action TrentService.GenerateDataKeyPairWithoutPlaintext` | ✓ `simulators/aws/kms_crypto.go:52::handleKMSGenerateDataKeyPairWithoutPlaintext` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action TrentService.DeriveSharedSecret` | ✓ `simulators/aws/kms_crypto.go:53::handleKMSDeriveSharedSecret` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
