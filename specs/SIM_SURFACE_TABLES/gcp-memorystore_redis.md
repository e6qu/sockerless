...
|---|---|---|---|---|---|
| `POST /v1/projects/{project}/locations/{location}/instances` | ✓ `simulators/gcp/memorystore_redis.go:47::handleMSRedisCreate` | ✗ (deferred under BUG-1159 sweep) | ✗ (deferred under BUG-1147 sweep) | n/a | |
| `GET /v1/projects/{project}/locations/{location}/instances/{id}` | ✓ `simulators/gcp/memorystore_redis.go:48::handleMSRedisGet` | ✗ (deferred under BUG-1159 sweep) | ✗ (deferred under BUG-1147 sweep) | n/a | |
