...
| `Action GraniteServiceVersion20100801.PutMetricStream` | ✓ `simulators/aws/cloudwatch_metric_streams.go:124::handleCWJSONPutMetricStream` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action GraniteServiceVersion20100801.GetMetricStream` | ✓ `simulators/aws/cloudwatch_metric_streams.go:125::handleCWJSONGetMetricStream` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action GraniteServiceVersion20100801.DeleteMetricStream` | ✓ `simulators/aws/cloudwatch_metric_streams.go:126::handleCWJSONDeleteMetricStream` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action GraniteServiceVersion20100801.ListMetricStreams` | ✓ `simulators/aws/cloudwatch_metric_streams.go:127::handleCWJSONListMetricStreams` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action GraniteServiceVersion20100801.StartMetricStreams` | ✓ `simulators/aws/cloudwatch_metric_streams.go:128::handleCWJSONStartMetricStreams` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action GraniteServiceVersion20100801.StopMetricStreams` | ✓ `simulators/aws/cloudwatch_metric_streams.go:129::handleCWJSONStopMetricStreams` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action PutMetricStream` | ✓ `simulators/aws/cloudwatch_metric_streams.go:392::handleCWQueryPutMetricStream` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action GetMetricStream` | ✓ `simulators/aws/cloudwatch_metric_streams.go:393::handleCWQueryGetMetricStream` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action DeleteMetricStream` | ✓ `simulators/aws/cloudwatch_metric_streams.go:394::handleCWQueryDeleteMetricStream` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action ListMetricStreams` | ✓ `simulators/aws/cloudwatch_metric_streams.go:395::handleCWQueryListMetricStreams` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action StartMetricStreams` | ✓ `simulators/aws/cloudwatch_metric_streams.go:396::handleCWQueryStartMetricStreams` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action StopMetricStreams` | ✓ `simulators/aws/cloudwatch_metric_streams.go:397::handleCWQueryStopMetricStreams` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
