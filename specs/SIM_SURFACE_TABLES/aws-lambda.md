...
|---|---|---|---|---|---|
| `POST /2015-03-31/functions` | ✓ `simulators/aws/lambda.go:363::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /2015-03-31/functions/{name}` | ✓ `simulators/aws/lambda.go:364::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `DELETE /2015-03-31/functions/{name}` | ✓ `simulators/aws/lambda.go:365::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `PUT /2015-03-31/functions/{name}/configuration` | ✓ `simulators/aws/lambda.go:366::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `POST /2015-03-31/functions/{name}/invocations` | ✓ `simulators/aws/lambda.go:367::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /2015-03-31/functions` | ✓ `simulators/aws/lambda.go:368::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /2015-03-31/functions/` | ✓ `simulators/aws/lambda.go:369::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /2017-03-31/tags/{arn...}` | ✓ `simulators/aws/lambda.go:370::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `POST /2017-03-31/tags/{arn...}` | ✓ `simulators/aws/lambda.go:371::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `DELETE /2017-03-31/tags/{arn...}` | ✓ `simulators/aws/lambda.go:372::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `POST /2015-03-31/functions/{name}/versions` | ✓ `simulators/aws/lambda.go:375::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /2015-03-31/functions/{name}/versions` | ✓ `simulators/aws/lambda.go:376::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `POST /2015-03-31/functions/{name}/aliases` | ✓ `simulators/aws/lambda.go:377::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /2015-03-31/functions/{name}/aliases` | ✓ `simulators/aws/lambda.go:378::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /2015-03-31/functions/{name}/aliases/{alias}` | ✓ `simulators/aws/lambda.go:379::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `PUT /2015-03-31/functions/{name}/aliases/{alias}` | ✓ `simulators/aws/lambda.go:380::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `DELETE /2015-03-31/functions/{name}/aliases/{alias}` | ✓ `simulators/aws/lambda.go:381::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `POST /2015-03-31/functions/{name}/policy` | ✓ `simulators/aws/lambda.go:382::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /2015-03-31/functions/{name}/policy` | ✓ `simulators/aws/lambda.go:383::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `DELETE /2015-03-31/functions/{name}/policy/{statement}` | ✓ `simulators/aws/lambda.go:384::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `POST /2021-10-31/functions/{name}/url` | ✓ `simulators/aws/lambda.go:385::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /2021-10-31/functions/{name}/url` | ✓ `simulators/aws/lambda.go:386::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `PUT /2021-10-31/functions/{name}/url` | ✓ `simulators/aws/lambda.go:387::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `DELETE /2021-10-31/functions/{name}/url` | ✓ `simulators/aws/lambda.go:388::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /2021-10-31/functions/{name}/urls` | ✓ `simulators/aws/lambda.go:389::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `POST /2015-03-31/event-source-mappings` | ✓ `simulators/aws/lambda.go:392::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /2015-03-31/event-source-mappings` | ✓ `simulators/aws/lambda.go:393::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /2015-03-31/event-source-mappings/{uuid}` | ✓ `simulators/aws/lambda.go:394::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `PUT /2015-03-31/event-source-mappings/{uuid}` | ✓ `simulators/aws/lambda.go:395::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `DELETE /2015-03-31/event-source-mappings/{uuid}` | ✓ `simulators/aws/lambda.go:396::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `POST /2018-10-31/layers/{layer}/versions` | ✓ `simulators/aws/lambda.go:401::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /2018-10-31/layers/{layer}/versions` | ✓ `simulators/aws/lambda.go:402::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /2018-10-31/layers/{layer}/versions/{version}` | ✓ `simulators/aws/lambda.go:403::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `DELETE /2018-10-31/layers/{layer}/versions/{version}` | ✓ `simulators/aws/lambda.go:404::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /2018-10-31/layers` | ✓ `simulators/aws/lambda.go:409::cloudTrailRecordedRESTDynamic` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `PUT /2017-10-31/functions/{name}/concurrency` | ✓ `simulators/aws/lambda.go:412::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /2019-09-30/functions/{name}/concurrency` | ✓ `simulators/aws/lambda.go:413::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `DELETE /2017-10-31/functions/{name}/concurrency` | ✓ `simulators/aws/lambda.go:414::cloudTrailRecordedREST` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
