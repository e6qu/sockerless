...
Surface: `simulators/azure/servicebus_dataplane.go` and `simulators/azure/servicebus_amqp.go` via the `{namespace}.servicebus.<sim-host>` subdomain wrapper and the raw Service Bus AMQP/TLS listener.
