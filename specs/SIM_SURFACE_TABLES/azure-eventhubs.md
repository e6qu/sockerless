...
Surface: `simulators/azure/eventhub.go` for ARM control-plane routes, plus `simulators/azure/servicebus_amqp.go` for Event Hubs AMQP send/receive over the shared raw AMQP/TLS listener.
