...
|---|---|---|---|---|---|
| `Action CreateDBInstance` | ✓ `simulators/aws/rds.go:265::handleRDSCreate` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action DescribeDBInstances` | ✓ `simulators/aws/rds.go:266::handleRDSDescribe` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action ModifyDBInstance` | ✓ `simulators/aws/rds.go:267::handleRDSModify` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action DeleteDBInstance` | ✓ `simulators/aws/rds.go:268::handleRDSDelete` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action AddTagsToResource` | ✓ `simulators/aws/rds.go:269::handleRDSAddTags` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action ListTagsForResource` | ✓ `simulators/aws/rds.go:270::handleRDSListTags` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action RemoveTagsFromResource` | ✓ `simulators/aws/rds.go:271::handleRDSRemoveTags` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action CreateDBSnapshot` | ✓ `simulators/aws/rds.go:272::handleRDSCreateSnapshot` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action DescribeDBSnapshots` | ✓ `simulators/aws/rds.go:273::handleRDSDescribeSnapshots` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action DescribeDBSnapshotAttributes` | ✓ `simulators/aws/rds.go:274::handleRDSDescribeSnapshotAttributes` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action DeleteDBSnapshot` | ✓ `simulators/aws/rds.go:275::handleRDSDeleteSnapshot` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action RestoreDBInstanceFromDBSnapshot` | ✓ `simulators/aws/rds.go:276::handleRDSRestoreFromSnapshot` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action CopyDBSnapshot` | ✓ `simulators/aws/rds.go:277::handleRDSCopySnapshot` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action RebootDBInstance` | ✓ `simulators/aws/rds.go:278::handleRDSReboot` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action CreateDBInstanceReadReplica` | ✓ `simulators/aws/rds.go:279::handleRDSCreateReadReplica` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action StartDBInstance` | ✓ `simulators/aws/rds.go:280::handleRDSStartInstance` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action StopDBInstance` | ✓ `simulators/aws/rds.go:281::handleRDSStopInstance` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action PromoteReadReplica` | ✓ `simulators/aws/rds.go:282::handleRDSPromoteReadReplica` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action ModifyDBSnapshotAttribute` | ✓ `simulators/aws/rds.go:283::handleRDSModifySnapshotAttribute` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action DescribeDBParameters` | ✓ `simulators/aws/rds.go:284::handleRDSDescribeParameters` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action ModifyDBParameterGroup` | ✓ `simulators/aws/rds.go:285::handleRDSModifyParameterGroup` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action ResetDBParameterGroup` | ✓ `simulators/aws/rds.go:286::handleRDSResetParameterGroup` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action CreateDBCluster` | ✓ `simulators/aws/rds.go:289::handleRDSCreateCluster` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action DescribeDBClusters` | ✓ `simulators/aws/rds.go:290::handleRDSDescribeClusters` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action ModifyDBCluster` | ✓ `simulators/aws/rds.go:291::handleRDSModifyCluster` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action DeleteDBCluster` | ✓ `simulators/aws/rds.go:292::handleRDSDeleteCluster` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action StartDBCluster` | ✓ `simulators/aws/rds.go:293::handleRDSStartCluster` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action StopDBCluster` | ✓ `simulators/aws/rds.go:294::handleRDSStopCluster` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action FailoverDBCluster` | ✓ `simulators/aws/rds.go:295::handleRDSFailoverCluster` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action DescribeDBClusterParameters` | ✓ `simulators/aws/rds.go:296::handleRDSDescribeClusterParameters` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action ModifyDBClusterParameterGroup` | ✓ `simulators/aws/rds.go:297::handleRDSModifyClusterParameterGroup` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action CreateGlobalCluster` | ✓ `simulators/aws/rds.go:300::handleRDSCreateGlobalCluster` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action DescribeGlobalClusters` | ✓ `simulators/aws/rds.go:301::handleRDSDescribeGlobalClusters` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action ModifyGlobalCluster` | ✓ `simulators/aws/rds.go:302::handleRDSModifyGlobalCluster` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action DeleteGlobalCluster` | ✓ `simulators/aws/rds.go:303::handleRDSDeleteGlobalCluster` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action CreateEventSubscription` | ✓ `simulators/aws/rds.go:306::handleRDSCreateEventSubscription` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action DescribeEventSubscriptions` | ✓ `simulators/aws/rds.go:307::handleRDSDescribeEventSubscriptions` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action ModifyEventSubscription` | ✓ `simulators/aws/rds.go:308::handleRDSModifyEventSubscription` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action DeleteEventSubscription` | ✓ `simulators/aws/rds.go:309::handleRDSDeleteEventSubscription` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action CreateDBClusterEndpoint` | ✓ `simulators/aws/rds.go:312::handleRDSCreateClusterEndpoint` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action DescribeDBClusterEndpoints` | ✓ `simulators/aws/rds.go:313::handleRDSDescribeClusterEndpoints` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action DeleteDBClusterEndpoint` | ✓ `simulators/aws/rds.go:314::handleRDSDeleteClusterEndpoint` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action CreateDBClusterSnapshot` | ✓ `simulators/aws/rds.go:317::handleRDSCreateClusterSnapshot` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action DescribeDBClusterSnapshots` | ✓ `simulators/aws/rds.go:318::handleRDSDescribeClusterSnapshots` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action DeleteDBClusterSnapshot` | ✓ `simulators/aws/rds.go:319::handleRDSDeleteClusterSnapshot` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action CopyDBClusterSnapshot` | ✓ `simulators/aws/rds.go:320::handleRDSCopyClusterSnapshot` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action CreateDBClusterParameterGroup` | ✓ `simulators/aws/rds.go:323::handleRDSCreateClusterParamGroup` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action DescribeDBClusterParameterGroups` | ✓ `simulators/aws/rds.go:324::handleRDSDescribeClusterParamGroups` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action DeleteDBClusterParameterGroup` | ✓ `simulators/aws/rds.go:325::handleRDSDeleteClusterParamGroup` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action CreateOptionGroup` | ✓ `simulators/aws/rds.go:328::handleRDSCreateOptionGroup` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action DescribeOptionGroups` | ✓ `simulators/aws/rds.go:329::handleRDSDescribeOptionGroups` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action DeleteOptionGroup` | ✓ `simulators/aws/rds.go:330::handleRDSDeleteOptionGroup` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action DescribeEvents` | ✓ `simulators/aws/rds.go:332::handleRDSDescribeEvents` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action DescribeEventCategories` | ✓ `simulators/aws/rds.go:333::handleRDSDescribeEventCategories` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action DescribeDBEngineVersions` | ✓ `simulators/aws/rds.go:334::handleRDSDescribeEngineVersions` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action DescribeOrderableDBInstanceOptions` | ✓ `simulators/aws/rds.go:335::handleRDSDescribeOrderableOptions` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action CreateDBSubnetGroup` | ✓ `simulators/aws/rds.go:338::handleRDSCreateSubnetGroup` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action DescribeDBSubnetGroups` | ✓ `simulators/aws/rds.go:339::handleRDSDescribeSubnetGroups` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action ModifyDBSubnetGroup` | ✓ `simulators/aws/rds.go:340::handleRDSModifySubnetGroup` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action DeleteDBSubnetGroup` | ✓ `simulators/aws/rds.go:341::handleRDSDeleteSubnetGroup` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action CreateDBParameterGroup` | ✓ `simulators/aws/rds.go:344::handleRDSCreateParamGroup` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action DescribeDBParameterGroups` | ✓ `simulators/aws/rds.go:345::handleRDSDescribeParamGroups` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action DeleteDBParameterGroup` | ✓ `simulators/aws/rds.go:346::handleRDSDeleteParamGroup` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
