...
| `azure-containerinstance` | direct | direct | direct | `simulators/azure/sdk-tests/phase_g_services_test.go`; `simulators/azure/cli-tests/phase_g_services_test.go`; `simulators/azure/terraform-tests/main.tf` |
...
| `azure-logicapps` | direct | direct | direct | `simulators/azure/sdk-tests/phase_g_services_test.go`; `simulators/azure/cli-tests/phase_g_services_test.go`; `simulators/azure/terraform-tests/main.tf` |
...
| `gcp-bigtable` | direct | direct | tracked BUG-1585 | `simulators/gcp/sdk-tests/phase_g_services_test.go`; `simulators/gcp/cli-tests/phase_g_services_test.go`; Terraform provider Bigtable Admin calls bypass the REST custom endpoint and hit real Google auth. |
...
| `gcp-dataflow` | direct | direct | not applicable | `simulators/gcp/sdk-tests/phase_g_services_test.go`; `simulators/gcp/cli-tests/phase_g_services_test.go` |
...
| `gcp-spanner` | direct | direct | direct | `simulators/gcp/sdk-tests/phase_g_services_test.go`; `simulators/gcp/cli-tests/phase_g_services_test.go`; `simulators/gcp/terraform-tests/main.tf` |
