...
1. The work touches a file under `simulators/<cloud>/<service>.go` AND adds, removes, or modifies a handler.
...
git diff --name-only origin/main...HEAD | grep -E "simulators/.+/[^/]+\.go$" | xargs -I{} basename {} .go | sort -u
