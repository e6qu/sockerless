...
tf-int-test-ecs: tf-int-build       ; docker run --rm --network host -v /var/run/docker.sock:/var/run/docker.sock $(TF_INT_IMAGE) ecs
tf-int-test-lambda: tf-int-build    ; docker run --rm --network host -v /var/run/docker.sock:/var/run/docker.sock $(TF_INT_IMAGE) lambda
tf-int-test-cloudrun: tf-int-build  ; docker run --rm --network host -v /var/run/docker.sock:/var/run/docker.sock $(TF_INT_IMAGE) cloudrun
tf-int-test-gcf: tf-int-build       ; docker run --rm --network host -v /var/run/docker.sock:/var/run/docker.sock $(TF_INT_IMAGE) gcf
tf-int-test-aca: tf-int-build       ; docker run --rm --network host -v /var/run/docker.sock:/var/run/docker.sock $(TF_INT_IMAGE) aca
tf-int-test-azf: tf-int-build       ; docker run --rm --network host -v /var/run/docker.sock:/var/run/docker.sock $(TF_INT_IMAGE) azf
