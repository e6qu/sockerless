...
- Deploy the published operator-console and simulator images in the shared development environment, keeping the console behind Shauth and simulator cloud APIs on their native protocol contracts.
