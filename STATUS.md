...
| Branch purpose | The shared operator and simulator interface was polished across responsive light/dark layouts, Admin became a standards-compliant Shauth logout participant, and all three simulator UIs gained shared first-party OpenID Connect sessions. |
