...
| Current fixes | BUG-2512 through BUG-2516 were fixed on this branch. Routed release pages manage metadata and object-backed assets through public GitHub APIs; release tags resolve/create real git refs; cross-repository updates fail before mutation; release lifecycle webhooks and GitHub Actions events reflect real state transitions; and all remaining pull-request/repository-dispatch workflow discovery runs synchronously against mutable git storage. |
...
| Bugs | See [BUGS.md](BUGS.md) header: 2516 filed, 2472 fixed, 3 open, 16 false positives. Open: BUG-2441, BUG-1345, and BUG-1075. |
