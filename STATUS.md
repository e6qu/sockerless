...
| In-flight | **Phase 161 — comprehensive vibe-slop sweep + fixes.** 12 BUGs filed (BUG-994…BUG-1005) covering 7 anti-pattern categories from `docs/VIBE_CODING.md` across backends/, simulators/, bleephub/, cmd/. Documented + fixed in one PR. |
...
| Bugs | 12 open · 993 fixed (1005 total filed). |
| Live infra | None up. |
