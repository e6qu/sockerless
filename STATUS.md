...
| Bugs | See [BUGS.md](BUGS.md) header: 2432 filed, 2389 fixed, 2 open, 16 false positives. Open: BUG-1345 and BUG-1075. |
| Local Docker | Temporarily unavailable on this host; the local Bleephub Go hook ran non-Docker coverage, and Docker-backed Bleephub/Codespaces validation stayed required in CI until the local Docker-compatible runtime returned. |
| Live infra | None up. |
