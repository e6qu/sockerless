...
| Branch purpose | Continued the Bleephub UI/API completeness audit after merged #791 across the release provider, parity audit, shared UI themes, repository organization/actions, clean browser viewer-state reads, and a retained GitHub Classroom transition product. |
| Current fixes | BUG-2512 through BUG-2522 and BUG-2524 through BUG-2530 were fixed on this branch except the still-open aggregate BUG-2523. In addition to routed, git/object-backed, event-complete release and repository UI work, Bleephub retained GitHub Classroom through organization-admin browser management, identifier-first rosters, real git-backed individual/group assignment acceptance, feedback pull requests, generated GitHub Actions autograding, derived grading, lossless transition bundles, and official client coverage in saturated light/dark UI. BUG-2523 remained open for four other operator-ingested domains. |
...
| Bugs | See [BUGS.md](BUGS.md) header: 2530 filed, 2485 fixed, 4 open, 16 false positives. Open: BUG-2523, BUG-2441, BUG-1345, and BUG-1075. |
...
- Replace BUG-2523's remaining four operator-ingested domains with real GitHub-compatible browser or producer workflows: GitHub Marketplace purchases, CodeQL database production, hosted-compute network onboarding, and fine-grained personal access token creation.
