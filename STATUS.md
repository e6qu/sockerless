...
| Bugs | See [BUGS.md](BUGS.md) header: 2587 filed, 2540 fixed, 10 open, 16 false positives. The local Amazon Elastic Container Service Terraform simulator apply/destroy hang remained tracked as BUG-2569. |
