...
| Last merged | GCP timestamp reopen and AWS core services: CloudTrail, Auto Scaling, EBS lifecycle/snapshots, and ECS managed EBS data round trip. |
| Open GitHub issues | #332-#338 at last check after #310, #341, #343, #346, and #347 were resolved. |
| Bugs | 1276 filed - 1276 fixed - 3 open - 2 false positives. |
