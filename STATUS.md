...
| Bugs | See [BUGS.md](BUGS.md) header: 2448 filed, 2403 fixed, 4 open, 16 false positives. Open: BUG-2447, BUG-2441, BUG-1345, and BUG-1075. |
...
- Keep the open gaps visible: BUG-2447 durable GitHub Actions workflow-run history, BUG-2441 current `knip`/Node deprecation warning, BUG-1075 live-cloud validation, and BUG-1345 AzureAD Terraform provider upstream endpoint support.
