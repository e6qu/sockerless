...
| Bugs | See [BUGS.md](BUGS.md) header: 2446 filed, 2401 fixed, 4 open, 16 false positives. Open: BUG-2446, BUG-2441, BUG-1345, and BUG-1075. |
...
- Keep the open gaps visible: BUG-2446 GraphQL status-rollup workflow/count completeness, BUG-2441 current `knip`/Node deprecation warning, BUG-1075 live-cloud validation, and BUG-1345 AzureAD Terraform provider upstream endpoint support.
