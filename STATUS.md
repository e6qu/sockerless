...
| Current fixes | BUG-2512 through BUG-2517 were fixed on this branch. Routed release pages manage metadata and object-backed assets through public GitHub APIs; release tags resolve/create real git refs; cross-repository updates fail before mutation; release lifecycle webhooks and GitHub Actions events reflect real state transitions; all remaining workflow discovery runs synchronously against mutable git storage; and Bleephub uses current `github.com/yuin/goldmark` 1.8.4. |
...
| Bugs | See [BUGS.md](BUGS.md) header: 2517 filed, 2473 fixed, 3 open, 16 false positives. Open: BUG-2441, BUG-1345, and BUG-1075. |
