...
| Bugs | 1248 filed - 1248 fixed - 2 open - 2 false positives. |
...
- Azure Terraform CI installed Caddy on the runner for the direct `make terraform-test` path, and GCP arithmetic SDK coverage asserted the actual `"Result: 30"` Cloud Logging payload.
