...
| Last merged | AWS simulator fidelity fixes for issues #305-#308 and #317-#320. |
| Open GitHub issues | #304, #309-#315, and #321-#329. |
| Bugs | 1264 filed - 1262 fixed - 5 open - 2 false positives. |
| Open BUGs | BUG-1075 live-cloud validation; BUG-1104 audit cadence; BUG-1254 GCP client-surface gaps; BUG-1263 GCP API-shape backlog; BUG-1264 Azure API-shape backlog. |
| Live infra | None up. |
