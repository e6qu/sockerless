...
| Bugs | See [BUGS.md](BUGS.md) header: 2582 filed, 2535 fixed, 10 open, 16 false positives. The local Amazon Elastic Container Service Terraform simulator apply/destroy hang remained tracked as BUG-2569. |
