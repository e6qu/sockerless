...
| Last merged | PR #246 - foundational simulator service audit - documented object-storage/data/DNS/queue/event/network/load-balancer/VM-equivalent coverage across AWS/GCP/Azure, filed BUG-1197..1207 for the real gaps, and fixed the CI regressions tracked as BUG-1208/BUG-1209 (2026-05-27). |
| Standing merge auth | **None.** User merges every PR. |
| Cells | 8/8 runner-integration cells GREEN since 2026-05-07. |
| Bugs | 1209 filed · 1198 fixed · 13 open · 2 false positives. Open: BUG-1075, BUG-1104, BUG-1197..1207. |
| Live infra | None up. |
