...
| | |
|---|---|
| Active branch | `main` — idle after issues #236/#237 GCS object metadata persistence fixes. |
| In-flight | None. Ready for the next fresh issue sweep. |
| Last merged | PR #238 — GCS copy/rewrite destination metadata and shared object persistence (2026-05-27). |
| Standing merge auth | **None.** User merges every PR. |
| Cells | 8/8 runner-integration cells GREEN since 2026-05-07. |
| Bugs | 1191 filed · 1191 fixed · 2 open · 2 false positives. Open: BUG-1075 + BUG-1104. |
| Live infra | None up. |
