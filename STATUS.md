...
| Operator identity | `sockerless-admin` supported optional Shauth OpenID Connect browser sign-in for its operator UI and administration API while simulator cloud APIs remained protocol-faithful. |
