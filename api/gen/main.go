...
func shouldOmitempty(structName, fieldName string, p PropDef) bool {
	...
	omitFields := map[string]map[string]bool{
		...
		"ImageBuildOptions": {
			...
			"cacheFrom": true, "cacheTo": true, "secrets": true,
			"memory": true, "memswap": true, "cpuShares": true,
			"cpuPeriod": true, "cpuQuota": true, "cpuSetCpus": true,
			"cgroupParent": true, "squash": true, "remote": true,
			"outputs": true, "version": true,
			"quiet": false,
		},
