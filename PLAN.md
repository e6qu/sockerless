...
- **BUG-2446 GraphQL status-rollup completeness:** status-check rollup connections still need richer count fields and real workflow-run links from check suites.
