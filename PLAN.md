...
18. **All sims — timestamps + state stamps respect-on-write.** Audit pass — most stamps are write-time as required, but a final sweep for re-stamping on read is on the to-do list.
