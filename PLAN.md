...
- **BUG-2447 GitHub Actions run durability:** workflow runs still need durable SQLite-backed history so run lists, run detail, and check-suite workflow links survive service restarts.
