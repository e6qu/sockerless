...
The active branch continued from merged #788 by making GitHub Pages a real publication service: deployment consumed validated official archive formats, required signed workflow identity and Pages-specific permissions, stored published bytes in object storage, served static content through usable site URLs, protected private sites, reclaimed replaced content, and deleted publication objects fail-loud.
