...
The active branch continued from merged #788 by making GitHub Pages deployment success depend on real artifact bytes retrieved through the supplied URL or repository-owned GitHub Actions artifact, with object-storage reads and content-identity validation failing loudly before Pages state changed.
