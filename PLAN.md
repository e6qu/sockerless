...
1. Replace BUG-2523's operator ingestion with GitHub-compatible browser/producer workflows for GitHub Classroom, GitHub Marketplace, CodeQL databases, hosted-compute network settings, and fine-grained personal access token requests.
