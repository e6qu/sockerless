...
Merged #791 made GitHub Pages branch publication and committed-reference eventing real. The active branch then closed the first UI/API completeness-audit class around releases: routed release and asset management, real git-tag identity, strict repository isolation, complete lifecycle events for webhooks and GitHub Actions, race-safe workflow discovery across release, pull-request, and repository-dispatch paths, and current dependency hygiene.
