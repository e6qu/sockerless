...
func (s *Server) registerGHChecksRoutes() {
	s.mux.HandleFunc("POST /api/v3/repos/{owner}/{repo}/check-runs", s.requirePerm(scopeChecks, permWrite, s.handleCreateCheckRun))
	s.mux.HandleFunc("GET /api/v3/repos/{owner}/{repo}/check-runs/{id}", s.requirePerm(scopeChecks, permRead, s.handleGetCheckRun))
	s.mux.HandleFunc("PATCH /api/v3/repos/{owner}/{repo}/check-runs/{id}", s.requirePerm(scopeChecks, permWrite, s.handleUpdateCheckRun))
	s.mux.HandleFunc("GET /api/v3/repos/{owner}/{repo}/check-runs/{id}/annotations", s.requirePerm(scopeChecks, permRead, s.handleListCheckRunAnnotations))
	s.mux.HandleFunc("GET /api/v3/repos/{owner}/{repo}/commits/{sha}/check-runs", s.requirePerm(scopeChecks, permRead, s.handleListCheckRunsForCommit))
	s.mux.HandleFunc("GET /api/v3/repos/{owner}/{repo}/commits/{sha}/check-suites", s.requirePerm(scopeChecks, permRead, s.handleListCheckSuitesForCommit))
	s.mux.HandleFunc("POST /api/v3/repos/{owner}/{repo}/check-suites", s.requirePerm(scopeChecks, permWrite, s.handleCreateCheckSuite))
	s.mux.HandleFunc("PATCH /api/v3/repos/{owner}/{repo}/check-suites/preferences", s.requirePerm(scopeAdministration, permWrite, s.handleUpdateCheckSuitePrefs))
	s.mux.HandleFunc("GET /api/v3/repos/{owner}/{repo}/check-suites/{id}", s.requirePerm(scopeChecks, permRead, s.handleGetCheckSuite))
	s.mux.HandleFunc("GET /api/v3/repos/{owner}/{repo}/check-suites/{id}/check-runs", s.requirePerm(scopeChecks, permRead, s.handleListCheckRunsForSuite))
}
