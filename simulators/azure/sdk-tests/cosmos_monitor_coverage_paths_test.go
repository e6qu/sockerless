...
// (simulators/azure/cosmos_metrics.go):
//
...
//
// Cosmos DB private endpoint connection routes (simulators/azure/cosmos_pec.go):
//
...
//
// Azure Monitor / Log Analytics query data plane (simulators/azure/monitor.go):
//
