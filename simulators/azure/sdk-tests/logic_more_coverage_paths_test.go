...
// simulators/azure/logicapps_more.go never appear verbatim in the test source.
...
// in simulators/azure/logicapps_more.go, driven by a genuine armlogic SDK call
