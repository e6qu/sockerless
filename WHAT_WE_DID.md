...
service does not have. Every pin moved to that release and the AWS Lambda
cell rejoined the `terraform-integration` matrix beside the five others
(BUG-2957).
...
the v0.30.7 cells found in v0.30.8, and the credential the Azure workload
hosts and the legacy docker build needed in v0.30.9, where the pin moved from v0.9.2 — the release also carries the Google
