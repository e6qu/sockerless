	...
	if req.HostConfig != nil {
		hostConfig = &container.HostConfig{
			...
			Resources: container.Resources{
				...
				MemorySwap:        req.HostConfig.MemorySwap,
				MemoryReservation: req.HostConfig.MemoryReservation,
				CPUShares:         req.HostConfig.CpuShares,
				CPUQuota:          req.HostConfig.CpuQuota,
				CPUPeriod:         req.HostConfig.CpuPeriod,
			...
			PidMode:         container.PidMode(req.HostConfig.PidMode),
			IpcMode:         container.IpcMode(req.HostConfig.IpcMode),
			UTSMode:         container.UTSMode(req.HostConfig.UTSMode),
			...
			Links:           req.HostConfig.Links,
			PublishAllPorts: req.HostConfig.PublishAllPorts,
			CgroupnsMode:   container.CgroupnsMode(req.HostConfig.CgroupnsMode),
			ConsoleSize:     req.HostConfig.ConsoleSize,
		}
...
func mapContainerFromDocker(info types.ContainerJSON) api.Container {
	...
	if info.HostConfig != nil {
		c.HostConfig = api.HostConfig{
			...
			MemoryReservation: info.HostConfig.Resources.MemoryReservation,
			...
			CpusetCpus:        info.HostConfig.Resources.CpusetCpus,
			CpusetMems:        info.HostConfig.Resources.CpusetMems,
			BlkioWeight:       info.HostConfig.Resources.BlkioWeight,
			NanoCpus:          info.HostConfig.Resources.NanoCPUs,
			PidsLimit:         info.HostConfig.Resources.PidsLimit,
			OomKillDisable:    info.HostConfig.Resources.OomKillDisable,
			PidMode:           string(info.HostConfig.PidMode),
			IpcMode:           string(info.HostConfig.IpcMode),
			UTSMode:           string(info.HostConfig.UTSMode),
			...
			CgroupnsMode:     string(info.HostConfig.CgroupnsMode),
