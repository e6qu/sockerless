...
import (
	...
	backend "github.com/sockerless/backend-lambda"
)
...
func main() {
	...
	obs, err := core.InitObservability("sockerless-backend-lambda")
	if err != nil {
	...
	logger := zerolog.New(output).
		Level(level).
		With().Timestamp().Str("component", "backend-lambda").Logger()
