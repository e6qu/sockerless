...
func TestMain(m *testing.M) {
	...
	buildBackend := exec.Command("go", "build", "-o", "sockerless-backend-azf", "./cmd/sockerless-backend-azf")
	...
	socketPath := fmt.Sprintf("/tmp/sockerless-azf-inttest-%d.sock", os.Getpid())
