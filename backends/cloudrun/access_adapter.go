// id-token access driver for the Cloud Run backend. Wraps
...
// the Service URL. Cloud Run rejects unauthenticated invokes by
// default — without this Authorization header the POST returns 401/403
// before the bootstrap sees it.
