...
// PodStop / PodKill / PodRemove must drive the cloud through this backend's own
// cloud-aware Container* methods. BaseServer's implementations mutate local
// Store state only and do no cloud work — for a stateless cloud backend that
